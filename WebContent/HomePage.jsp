...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li class="fa fa-user" ><div class="dropdown">
  <h1 class="dropbtn"><i><%=currentUser.getFname()+ " "+currentUser.getLname()%></i></h1>
  <div class="dropdown-content">
    <a href="Guest Profile.jsp">Profile</a>
    <a href="Guest Booking.jsp">Bookings</a>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>Hotel <span>Sheraton</span></h4>
...
<div class="col-md-9 book-form">
			   <form action="CheckAvailabilityServlet" method="get">
					...
					<div class="fields-w3ls form-date-w3-agileits">
						        <p>Arrival Date</p>
									<input  id="datepicker1" name="in" type="text" value="Select Date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								</div>
								<div class="fields-w3ls form-date-w3-agileits">
						        <p>Departure Date</p>
									<input  id="datepicker2" name="out" type="text" value="Select Date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								</div>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Sheraton</h3> 
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							<br><br>
							<div class="price-selet">
								<h3 style="align:center;">Rs 5000</h3>
								<br><br>
								<a href="#availability-agileits" class="scroll" >Book Now</a>
							</div>
						</div>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2017 Hotel Sheraton . All Rights Reserved | Design by <a href="http://w3layouts.com/">W3layouts</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
