...
<div class="main-w3l">
    ...
    <li style="color:#ffff99;font-size: 120%;"><%=availabilityUser.getCheckOut() %></li><br>
				...
				<br><br>	
				<button class="button button2" style="float:right;">Proceed >></button>			
	</form>
<form action = "HomePage.jsp" method="post">
<button class="button button2" style="float:left;">Cancel</button></form>
			<br>
			<br>
			
			<div align = "right">
			<form action = "BookARide.jsp" method="post" >
<button class="button button2" style="float:left;">Get a ride to hotel ?</button></form>
			</div>
