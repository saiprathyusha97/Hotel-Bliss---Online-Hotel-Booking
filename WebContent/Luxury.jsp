...
<link href="css/luxurystyle.css" rel="stylesheet" type="text/css" media="all" />
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="index.html" class="menu__link">Luxury</a></li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 align = "center">Luxury <span>Room</span></h4>
										<img src="images/luxury2.jpg" alt=" " class="img-responsive">
										<h5>In-room amenities include:</h5>
										<p>24 hour security, 24 hours power back, Caretaker, Free Wifi in Common, Kitchen</p>
										<p>These rooms also have required beauty eminities like hair spa, facial and many more.</p>
									</div>
								</div>
							</div>
						</div>
...
<div class="advantages">
	<div class="container">
		<div class="advantages-main">
				<h3 class="title-w3-agileits">Luxury</h3>
		   <div class="advantage-bottom">
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<img src = "images/luxury1.jpg" height = 300px, width = 450px>
			 	</div>
			 </div>
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
			 	<form action ="Booking Details.jsp"> 
					<h4>Price : Rs. 28,500</h4>
					<p><i class="fa fa-check" aria-hidden="true"></i>Type : LuxuryRoom</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Beds : One or more</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Description: Offering splendid Lutyens’ city or pool views, these spacious Luxury Rooms are thoughtfully appointed for the global business traveller. Enjoy a complimentary buffet breakfast at Machan.</p>
