				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item"><a href="#" class="menu__link scroll">Home</a></li>
							<li class="menu__item menu__item--current"><a href="#" class="menu__link">Deluxe</a></li>
					...
					<li>
						<div class="w3layouts-banner-top">
							<div class="container">
								...
								<h4>Deluxe</h4>
									<h3 style="color:#000099">We know what you love</h3>
										<p>Welcome to our hotel</p>
									<div class="agileits_w3layouts_more menu__item">
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">NOT AVAILABLE</a>
			</div><h3 style="color:#000099">GO FOR ANOTHER ROOM</h3>
								</div>	
							</div>
						</div>
					</li>
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>Deluxe</h4>
									<h3 style="color:#000099">Stay with friends & families</h3>
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top2">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>Deluxe</h4>
								<h3 style="color:#000099">want luxurious vacation?</h3>
										<p>Get accommodation today</p>
									<div class="agileits_w3layouts_more menu__item">
											<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">NOT AVAILABLE</a>
									</div>
									<br>
									<h3 style="color:#000099">GO FOR ANOTHER ROOM</h3>
								</div>
							</div>
						</div>
					</li>
