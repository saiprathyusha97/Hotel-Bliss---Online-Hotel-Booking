...
<link href="css/deluxestyle.css" rel="stylesheet" type="text/css" media="all" />
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item menu__item--current"><a href="index.html" class="menu__link">Deluxe</a></li>
							<li class="menu__item"><a href="#HomePage.jsp" class="menu__link scroll">Home</a></li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4 align = "center">Deluxe <span>Room</span></h4>
										<img src="images/deluxe 4.jpg" alt=" " class="img-responsive">
										<h5>In-room amenities include:</h5>
										<p>Room Features:Individual climate control, Tea and coffee making facilities, 220V/240V electrical sockets</p>
										<p>Communication & Technology: Free WiFi, International calls by operator</p>
										<p>Entertainment: LCD TV, Satellite channels</p>
										<p>Extra Facilities: Shower, Housekeeping & In-room Services, Turn down service</p>
									</div>
								</div>
							</div>
						</div>
...
<div class="advantages">
	<div class="container">
		<div class="advantages-main">
				<h3 class="title-w3-agileits">Deluxe Room</h3>
		   <div class="advantage-bottom">
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					
			 		<img src = "images/deluxe3.jpg" height = 300px, width = 450px>
			 	</div>
			 </div>
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<form action ="Booking Details.jsp"> 
			 		<h4>Price : Rs. 25,000</h4>
					<p><i class="fa fa-check" aria-hidden="true"></i>Type : DeluxeRoom</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Beds : One or more</p>
					<p><i class="fa fa-check" aria-hidden="true"></i>Description: Comfortable and pleasant working space, LCD television and high speed internet connection</p>
